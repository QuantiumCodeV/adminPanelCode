...
>
  ...
  @include('fonts')<link
    ...
    />
    <meta charset="utf-8" />
    <title>SaaS Onboarding Flows (Copy to Figma)</title>
    <meta
      content="First impressions count. Onboarding is crucial to set your users up for success. Get inspiration from the best software onboarding flows (and copy to Figma)."
      name="description"
    />
    <meta content="SaaS Onboarding Flows (Copy to Figma)" property="og:title" />
    <meta
      content="First impressions count. Onboarding is crucial to set your users up for success. Get inspiration from the best software onboarding flows (and copy to Figma)."
      property="og:description"
    />
    <meta
      content="https://cdn.prod.website-files.com/635584277e62506ebe08fb74/663526fb8f023d66ea1ac078_Graph%20url%20(1).png"
      property="og:image"
    />
    <meta
      content="SaaS Onboarding Flows (Copy to Figma)"
        ...
        <div class="design-inspiration-header">
          ...
          <div class="h1-wrapper">
            <div class="h1-line-wrapper">
              ...
              <h1 class="home-h1 extra-space">SaaS</h1>
            </div>
            <h1 class="home-h1">onboarding flows.</h1>
          </div>
          <div class="inspiration-description">
            <div class="design-inspis-normal-text">
              First impressions count. Learn from the best onboarding flows top
