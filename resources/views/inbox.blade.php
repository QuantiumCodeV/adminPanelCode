...
<head>
  ...
  <link as="script" href="./inbox_files/home-64ceef88cee3e322.js" rel="prefetch" />
  <link as="script" href="./inbox_files/captures-5712dfcc4d1f1682.js" rel="prefetch" />
  <link as="script" href="./inbox_files/899-fb0e87850e1e8a2d.js" rel="prefetch" />
  <link as="script" href="./inbox_files/analytics-f7aa99a2929628e8.js" rel="prefetch" />
  <link as="script" href="./inbox_files/users-b6268a0be19d5f0c.js" rel="prefetch" />
</head>
...
<body>
        ...
        <div class="bg-primary-100 bg-dot-grid-pattern bg-repeat bg-pattern w-screen h-screen">
            ...
            <section class="flex items-center justify-center">
              <div class="relative h-fit select-none w-full" data-orientation="horizontal" dir="ltr">
                <div aria-orientation="horizontal" class="rounded flex flex-row w-full justify-evenly gap-2" data-orientation="horizontal" role="tablist" style="outline: none" tabindex="0">
                  <a aria-controls="radix-:rv:-content-home" aria-selected="false" class="px-3 py-2 rounded border-opacity-0 flex items-center z-10 hover:bg-neutral-100 hover:transition-colors hover:cursor-cool-clickable disabled:cursor-cool-normal w-fit justify-center" data-orientation="horizontal" data-radix-collection-item="" data-state="inactive" href="{{ route("home") }}" id="radix-:rv:-trigger-home" role="tab" tabindex="-1" type="button">
                  ...
                  </a><a aria-controls="radix-:rv:-content-captures" aria-selected="true" class="px-3 py-2 rounded border-opacity-0 flex items-center z-10 hover:cursor-cool-clickable disabled:cursor-cool-normal w-fit justify-center" data-orientation="horizontal" data-radix-collection-item="" data-state="active" href="{{ route("captures") }}" id="radix-:rv:-trigger-captures" role="tab" tabindex="-1" type="button">
                    <div class="flex items-center justify-center gap-2 py-1">
                  ...
                  </a><a aria-controls="radix-:rv:-content-analytics" aria-selected="false" class="px-3 py-2 rounded border-opacity-0 flex items-center z-10 hover:bg-neutral-100 hover:transition-colors hover:cursor-cool-clickable disabled:cursor-cool-normal w-fit justify-center" data-orientation="horizontal" data-radix-collection-item="" data-state="inactive" href="{{ route("analytics") }}" id="radix-:rv:-trigger-analytics" role="tab" tabindex="-1" type="button">
                    <div class="flex items-center justify-center gap-2 py-1">
                      <svg class="h-6 w-6" style="max-width: 50vw; max-height: 50vh" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  </a><a aria-controls="radix-:rv:-content-users" aria-selected="false" class="px-3 py-2 rounded border-opacity-0 flex items-center z-10 hover:bg-neutral-100 hover:transition-colors hover:cursor-cool-clickable disabled:cursor-cool-normal w-fit justify-center" data-orientation="horizontal" data-radix-collection-item="" data-state="inactive" href="{{ route("friends") }}" id="radix-:rv:-trigger-users" role="tab" tabindex="-1" type="button">
                    <div class="flex items-center justify-center gap-2 py-1">
                ...
                <div class="flex flex-row items-center justify-center gap-2 text-left mr-2">
                  <div class="relative">
                    <div class="rounded-full border-neutral-700 relative overflow-hidden flex items-center justify-center bg-primary-500 relative w-10 h-10 min-w-[2.5rem] min-h-[2.5rem] border-1">
                      <img alt="Avatar" class="object-cover" src="{{ asset('assets/' . (auth()->user()->avatar ?: 'member_avatar_453.png')) }}" style="height:100%" />
                    </div>
              ...
              <div class="h-full w-full flex">
                  ...
                  <div class="w-full h-full">
                    <div class="w-full h-full flex flex-col bg-neutral-50 relative">
                      <div class="flex flex-col gap-4 bg-neutral-50 px-3 pt-3 pb-1 border-b-1 border-neutral-300 h-fit">
                        <section class="flex justify-between items-center">
                          <div>
                            <button class="flex items-center justify-center gap-2 rounded font-medium leading-4 whitespace-nowrap overflow-hidden text-overflow-ellipsis w-auto min-w-0 min-h-0 select-none px-3 py-2 bg-secondary-300 border-[2px] border-neutral-700 shadow-smoothxl opacity-100" style="
                              ...
                              <svg class="h-5 w-5" fill="none" style="max-width: 50vw; max-height: 50vh" viewbox="0 0 19 17" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <section class="flex justify-between items-center">
                          <p class="text-neutral-600">0 captures</p>
                          <button aria-autocomplete="none" aria-controls="radix-:r18:" aria-expanded="false" class="flex items-center justify-center w-fit rounded px-3 py-2 font-medium transition-colors select-none text-neutral-600 hover:bg-neutral-100" data-state="closed" dir="ltr" role="combobox" tabindex="0" type="button">
                            <span style="pointer-events: none">Newest</span>
                            <div aria-hidden="true" style="transform: none">
                              <svg class="h-6" style="max-width: 50vw; max-height: 50vh" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path class="stroke-2 stroke-neutral-600" d="m8 10 4 4 4-4" fill="none" stroke="#323232" stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M0 0h24v24H0Z" fill="none"></path>
                      ...
                      <section class="absolute z-30 bottom-4 w-full flex items-center justify-center pointer-events-none">
                        <div class="pointer-events-auto">
                          <div class="rounded w-fit bg-primary-300 flex items-center gap-2 py-1 px-2 shadow-lg outline-[0.15rem] outline-primary-500 outline-dashed -outline-offset-2 pointer-events-none" style="
                                opacity: 0;
                                transform: scale(0.5) translateZ(0px);
                              ">
                            <button class="flex items-center justify-center gap-2 rounded font-medium leading-4 whitespace-nowrap overflow-hidden text-overflow-ellipsis w-auto min-w-0 min-h-0 select-none px-3 py-2 bg-primary-200 border-[1.5px] border-primary-500 opacity-100" style="
                                  transform: none;
                                  transform-origin: 50% 50% 0px;
                                " tabindex="0" type="button">
                              <section class="flex items-center justify-center gap-2">
                                <svg class="h-5 stroke-neutral-700" style="max-width: 50vw; max-height: 50vh" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                  <g fill="none">
                            ...
                            </button><button class="flex items-center justify-center gap-2 rounded font-medium leading-4 whitespace-nowrap overflow-hidden text-overflow-ellipsis w-auto min-w-0 min-h-0 select-none px-3 py-2 bg-primary-200 border-[1.5px] border-primary-500 opacity-100" style="
                                  transform: none;
                                  transform-origin: 50% 50% 0px;
                                " tabindex="0" type="button">
                              <section class="flex items-center justify-center gap-2">
                                <svg class="h-5" fill="none" style="max-width: 50vw; max-height: 50vh" viewbox="0 0 22 21" xmlns="http://www.w3.org/2000/svg">
                            ...
                            </button><button class="flex items-center font-bold rounded focus:outline-none text-base font-bold" style="
                                  transform: none;
                                  transform-origin: 50% 50% 0px;
                                " tabindex="0">
                              <div class="p-2">
                                <svg class="h-8 w-8" style="max-width: 50vw; max-height: 50vh" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                  <g fill="none">
                                    <path d="M0 0h24v24H0Z"></path>
                ...
                <div class="flex-grow h-full flex flex-col gap-4 justify-between bg-primary-100 bg-dot-grid-pattern bg-repeat bg-pattern overflow-hidden">
                  <div class="flex-grow m-8 flex flex-col gap-4 items-center justify-center h-full rounded">
                    ...
                    <p class="text-center">
                      Upload feedback, user research or connect data sources
                      to<br />
          ...
          <div class="flex flex-col z-30">
            ...
            <div class="fixed bottom-2 right-2 w-11 h-11 rounded-full bg-primary-300 border-2 border-primary-600 p-4 shadow-lg flex items-center justify-center hover:cursor-cool-clickable disabled:cursor-cool-normal" style="z-index: 99999">
              <button aria-expanded="false" aria-haspopup="menu" class="flex items-center justify-center w-fit rounded font-medium transition-colors select-none text-neutral-600 px-3 py-2" data-state="closed" id="radix-:r1a:" tabindex="0" type="button">
  ...
  <next-route-announcer>
    <p aria-live="assertive" id="__next-route-announcer__" role="alert" style="
  ...
  </next-route-announcer><iframe aria-hidden="true" id="_hjSafeContext_45756041" src="./inbox_files/saved_resource.html" style="
        display: none !important;
        width: 1px !important;
        height: 1px !important;
        opacity: 0 !important;
        pointer-events: none !important;
      " tabindex="-1" title="_hjSafeContext"></iframe><iframe allow="payment *" allowtransparency="true" aria-hidden="true" frameborder="0" name="__privateStripeController1691" role="presentation" scrolling="no" src="./inbox_files/controller-with-preconnect-0ac892cc1983a4b6e5727ee594af4fd2.html" style="
      ...
      " tabindex="-1"></iframe><iframe aria-hidden="true" id="intercom-frame" src="./inbox_files/saved_resource(1).html" style="
  ...
  <iframe allow="payment *" allowtransparency="true" aria-hidden="true" frameborder="0" name="__privateStripeMetricsController1690" role="presentation" scrolling="no" src="./inbox_files/m-outer-3437aaddcdf6922d623e172c2d6f9278.html" style="
        border: none !important;
        margin: 0px !important;
        padding: 0px !important;
        width: 1px !important;
