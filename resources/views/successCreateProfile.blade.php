...
<html style="">
  ...
  ><head><link
    ...
    <link
      rel="preload"
      href="./successCreateProfile_files/b08c6edf6d5dd570.css"
      as="style"
    />
    <link
      rel="stylesheet"
    ...
    <div id="__next">
                  ...
                  <div class="h-full w-full flex flex-col justify-between">
                    <section class="flex-grow w-full flex flex-col gap-2">
                        ...
                        <div class="flex gap-2">
                          <div class="flex flex-col gap-2">
                            <section class="relative h-2 w-8">
                              ...
                              ></div>
                              <div
                                class="absolute bg-neutral-300 rounded h-2 w-8"
                              ></div>
                            </section>
                          </div>
                          <div class="flex flex-col gap-2">
                      ...
                      <div class="flex items-center justify-start mt-4 w-full">
                        ...
                        >
                          <div class="w-[8rem]"><h4>Next</h4></div>
                        </button>
                      </div>
                    </section>
            ...
            >
              <div class="h-full w-full p-20 flex items-center justify-center">
                <img
                  ...
                  data-nimg="1"
                  class="w-full h-auto"
                  src="/assets/listenup_tutorial_slide_import.png"
                  style="color: transparent"
                />
              </div>
            </section>
                        ...
                        <div class="w-full flex items-center gap-2">
                          ...
                          >
                            <path
                              ...
                              d="m17.074 4.92.66-.66M17.752 13.193l-.697-.706M9.495 4.92l-.66-.66"
                            ></path>
                            <path
                              class="stroke-2 stroke-primary-700"
                              stroke-linecap="round"
                            ...
                            <path
                              ...
                              stroke-linecap="round"
                              stroke-linejoin="round"
                              d="M12.102 12.485 9.508 9.9M13.279 3.226v-.935M18.773 8.715h.935"
                            ></path>
                          </svg>
            ...
            >
              <div class="h-full w-full p-20 flex items-center justify-center">
                <img
                  ...
                  data-nimg="1"
                  class="w-full h-auto"
                  src="/assets/listenup_tutorial_slide_highlight.png"
                  style="color: transparent"
                />
              </div>
            </section>
            ...
            >
              <div class="h-full w-full p-20 flex items-center justify-center">
                <img
                  ...
                  data-nimg="1"
                  class="w-full h-auto"
                  src="/assets/listenup_tutorial_slide_pattern.png"
                  style="color: transparent"
                />
              </div>
            </section>
                    ...
                    <section class="flex-grow w-full flex flex-col gap-2">
                      ...
                      <div class="flex items-center justify-start mt-4 w-full">
                        <button
                          ...
                          style="transform: none"
                        >
                          <div class="w-[8rem]"><h4>Try now</h4></div>
                        </button>
                      </div>
                    </section>
                    <div class="flex-1 w-full flex items-end"></div>
      ...
      <div id="section_5" style="display: none">
        ...
        >
          <div class="h-full w-full flex">
            <section
              class="h-screen bg-neutral-50 p-10 2xl:p-20 flex flex-col w-screen"
            >
              <div class="h-fit w-full mb-10 2xl:mb-28">
                <img
                  alt="SoundLine Navbar Logo"
              ...
              <div class="h-full w-full">
                ...
                >
                  <div class="max-w-[80rem]">
                    <div
                      class="h-fit w-[67rem] flex flex-col gap-2 justify-between items-center p-4"
                    >
                            ...
                            >
                                    ...
                                    >
                                      ...
                                      <div class="-rotate-90">
                                        ...
                                        >
                                          ...
                                          >
                                            <path
                                              d="M12.01 4.51v14.98M6.023 13.507 12 19.483l5.977-5.976"
                                            ></path>
                                          </g>
                                          <path
                                            fill="none"
                              ...
                              <div class="p-1 flex-1 min-w-0">
                                ...
                                >
                                  ...
                                  >
                                    <div
                                      class="flex-grow flex items-center justify-center overflow-clip"
                                    >
                                      ...
                                      <div class="flex items-center gap-2">
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            ></rect>
                                            <path
                                              d="M9 21V3M15 21V3M3 9h18M3 15h18"
                                            ></path>
                                          </g>
                                          <path
                                            fill="none"
                              ...
                              <div class="p-1 flex-1 min-w-0">
                                ...
                                >
                                  ...
                                  >
                                    <div
                                      class="flex-grow flex items-center justify-center scale-75 translate-y-4"
                                    >
                                      <img
                                        alt="Video Call Illustration"
                                        loading="lazy"
                  ...
                  >
                    <section
                      class="flex-1 w-full h-full flex items-center justify-center py-5 px-5"
                    >
                      ...
                      <div class="-translate-x-20 h-full">
                        <div
                          class="w-[1px] h-full bg-neutral-300 m-1 rounded-full w-[1px] bg-neutral-400"
                        ></div>
                      </div>
                    </section>
                    <section
                      class="flex-1 w-full h-full flex items-center justify-start translate-y-3 -translate-x-10"
                    >
                      <img
                        alt="SoundLine Navbar Logo"
                        loading="lazy"
                        ...
                        decoding="async"
                        data-nimg="1"
                        src="/assets/chrome-extension-banner.png"
                        style="color: transparent"
                      />
                    </section>
                  </div>
