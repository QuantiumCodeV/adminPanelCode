      ...
      ><style>
        *,
        ...
        @font-face {
          ...
          font-weight: 200;
          font-style: italic;
          src: url(PlusJakartaSans-ExtraLightItalic.4db0e375.woff2)
            format("woff2");
        }
        @font-face {
          font-family: jakarta;
        ...
        @font-face {
          ...
          font-weight: 600;
          font-style: italic;
          src: url(PlusJakartaSans-SemiBoldItalic.ab3b6f47.woff2)
            format("woff2");
        }
        @font-face {
          font-family: jakarta;
        ...
        @font-face {
          ...
          font-weight: 800;
          font-style: italic;
          src: url(PlusJakartaSans-ExtraBoldItalic.505495e3.woff2)
            format("woff2");
        }
        @font-face {
                ...
                <button data-state="closed">
                  ...
                  >
                    <img
                      ...
                      decoding="async"
                      data-nimg="1"
                      src="./insights_files/ListenUp-Logo-Title-Black-Sticker.svg"
                      ...
                      ><div class="flex items-center justify-center gap-2 py-1">
                        ...
                        >
                          <path
                            ...
                            stroke-linecap="round"
                            stroke-linejoin="round"
                            d="M12.967 3 4.75 14H12l-.967 7 8.217-11H12Z"
                          ></path>
                          <path fill="none" d="M0 0h24v24H0Z"></path>
                        </svg>
                ...
                >
                  ...
                  >
                    <div class="relative">
                      ...
                      >
                        <img
                          src="./insights_files/member_avatar_532.png"
                          alt="Avatar"
                          class="object-cover"
                        />
                      </div>
                      <div class="absolute -bottom-1 -right-1">
                        ...
                        >
                          <img
                            src="./insights_files/organization_avatar_508.png"
                            alt="Avatar"
                            class="object-cover"
                          />
                        </div>
            ...
            <div class="flex">
              <section class="h-[calc(100vh-4rem)] w-screen">
                <div class="h-full w-full overflow-y-auto relative">
                  ...
                  >
                    ...
                    >
                      <div class="flex items-center gap-1 h-full">
                        ...
                        <div
                          class="w-[1px] h-full bg-neutral-300 m-1 rounded-full bg-neutral-400 w-4 h-[45%] ml-2"
                        ></div>
                      </div>
                      <div>
                        <button
                            ...
                            >
                              ...
                              <g fill="none">
                                ...
                                <path
                                  ...
                                  stroke-linecap="round"
                                  stroke-linejoin="round"
                                  d="M9.165 10.146a.367.367 0 1 1-.52.519.367.367 0 0 1 .52-.52"
                                ></path>
                                <path
                                  class="stroke-2 stroke-neutral-700"
                                  stroke-linecap="round"
                        ...
                        <span style="pointer-events: none"
                          ><div class="flex items-center text-left">
                            ...
                            >
                              ...
                              >
                                <path
                                  d="M10 8 7 5 4 8M7 19V5M14 16l3 3 3-3M17 5v14"
                                ></path>
                              </g>
                              <path fill="none" d="M0 0h24v24H0Z"></path>
                            </svg>
                            ...
                            >
                              ...
                              >
                                <section class="w-full h-52">
                                  <div class="h-full w-full">
                                    <div
                                      class="rounded-md w-full h-full bg-neutral-200"
                                    ></div>
                                  </div>
                                </section>
                                <section
                                ...
                                >
                                  <div class="flex items-center gap-2">
                                    <div class="h-full w-full">
                                      <div
                                        class="rounded-md w-20 h-8 bg-neutral-200"
                                      ></div>
                                    </div>
                                    <div class="h-full w-full">
                                      <div
                                  ...
                                  <div>
                                    <div class="h-full w-full">
                                      <div
                                        class="rounded-md w-10 h-6 bg-neutral-200"
                                      ></div>
                                    </div>
                                  </div>
                                </section>
                                ...
                                >
                                  <div class="h-full w-full">
                                    <div
                                      class="rounded-md w-full h-5 bg-neutral-200"
                                    ></div>
                                  </div>
                                  <div class="h-full w-full">
                                    <div
                                  ...
                                  <div class="h-full w-full">
                                    <div
                                      class="rounded-md w-56 h-5 bg-neutral-200"
                                    ></div>
                                  </div>
                                </section>
                                <section
                                ...
                                >
                                  <div class="flex items-center gap-2">
                                    <div class="h-full w-full">
                                      <div
                                        class="rounded-full w-7 h-7 bg-neutral-200"
                                      ></div>
                                    </div>
                                    <div class="h-full w-full">
                                      <div
                                        class="rounded-md w-24 h-5 bg-neutral-200"
                                      ></div>
                                    </div>
                                  </div>
                                  <div>
                              ...
                              >
                                <section class="w-full h-[20rem] relative">
                                  <div class="h-full w-full">
                                    <div
                                      class="rounded-md w-full h-full absolute top-0 left-0 bg-neutral-200"
                                    ></div>
                                  </div>
                                  <div
                                  ...
                                  >
                                    <div class="h-full w-full">
                                      <div
                                        class="rounded-md w-24 h-6 bg-neutral-200"
                                      ></div>
                                    </div>
                                    <div>
                                      <div class="h-full w-full">
                                        <div
                                          class="rounded-md w-24 h-8 bg-neutral-200"
                                        ></div>
                                      </div>
                                    </div>
                                  </div>
                                ...
                                >
                                  <div class="h-full w-full">
                                    <div
                                      class="rounded-md w-full h-10 bg-neutral-200"
                                    ></div>
                                  </div>
                                </section>
                                <section
                  ...
                  <section
                    class="fixed z-30 bottom-4 w-full flex items-center justify-center pointer-events-none"
                  >
                    <div class="pointer-events-auto">
                      <div
                        class="rounded w-fit bg-primary-300 flex flex-col gap-2 py-1 px-2 shadow-lg outline-[0.15rem] outline-primary-500 outline-dashed -outline-offset-2 pointer-events-none"
                        style="
                          opacity: 0;
                      ...
                      >
                        <section class="flex justify-center items-center gap-2">
                          <div
                            class="flex items-center justify-center gap-2 mr-4 w-48"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 24 24"
                            ...
                            <h5><strong>0</strong> insights selected</h5>
                          </div>
                          <section
                          ...
                          >
                            ...
                            <div class="">
                              ...
                              >
                                <button
                                  type="button"
                                  class="flex items-center justify-center gap-2 rounded font-medium leading-4 whitespace-nowrap overflow-hidden text-overflow-ellipsis w-auto min-w-0 min-h-0 select-none p-0 bg-primary-200 border-[1.5px] border-primary-500 opacity-100"
                                  tabindex="0"
                                  style="
                                    transform: none;
                                    transform-origin: 50% 50% 0px;
                                ...
                                >
                                  <g fill="none">
                                    <path
                                      ...
                                      stroke-linecap="round"
                                      stroke-linejoin="round"
                                      d="M8.313 7.759a.389.389 0 1 1-.55.55.389.389 0 0 1 .55-.55"
                                    ></path>
                                    <path
                                      class="stroke-2 stroke-neutral-700"
                                      stroke-linecap="round"
                              ...
                              >
                                ...
                                >
                                  ...
                                  <path
                                    ...
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                                    d="M4 12.074V9.5a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v2.586"
                                  ></path>
                                  <path
                                    fill="none"
                                    class="stroke-2 stroke-neutral-700"
                          ...
                          >
                            <div>
                              ...
                              >
                                ...
                                >
                                  <g
                                    class="stroke-[3] stroke-neutral-700"
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                                    fill="none"
                                  >
                                    <path
                                      d="M18.5 12v0a.5.5 0 1 1-.5-.5h0a.5.5 0 0 1 .5.5M12.5 12v0a.5.5 0 1 1-.5-.5h0a.5.5 0 0 1 .5.5M6.5 12v0a.5.5 0 1 1-.5-.5h0a.5.5 0 0 1 .5.5"
                                    ></path>
                                  </g>
                          ...
                          ><button
                            class="flex items-center font-bold rounded focus:outline-none text-base font-bold px-3 py-3"
                            tabindex="0"
                            style="
                              transform: none;
                              transform-origin: 50% 50% 0px;
