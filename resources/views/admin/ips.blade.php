    ...
    window.hs_config = {
      ...
      copyDependencies: {
        ...
        build: {
          "{{  asset("
          assets / js / theme - custom.js ") }}": "",
          "node_modules/bootstrap-icons/font/*fonts/**": "{{  asset("
          assets / css ") }}",
        },
      },
      buildFolder: "",
            ...
            <div id="navbarVerticalMenuPagesMenu">
              ...
              <div class="nav-item">
                <a
                  ...
                  <span class="nav-link-title">Заявки
                    @if($requests > 0)
              ...
              <div class="nav-item">
                <a
                  ...
                  aria-controls="navbarVerticalMenuPagesUserProfileMenu">
                  <i class="bi-person nav-icon"></i>
                  <span class="nav-link-title">Забаненные IP
                  </span>
                </a>
              ...
              <tr>
                ...
                <td>
                  <a
                    ...
                    <div class="ms-3">
                      <span class="d-block h5 text-inherit mb-0">{{ $bannedIp->ip }}
                      </span>
                ...
                <td>
                  <a
                    ...
                    <div class="ms-3">
                      <span class="d-block h5 text-inherit mb-0">{{ $bannedIp->created_at }}
                      </span>
