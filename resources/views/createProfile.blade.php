...
<html style="">
  <head>
    ...
    <link
      rel="preload"
      href="createProfile_files/b08c6edf6d5dd570.css"
      as="style"
    />
    <link
      rel="stylesheet"
                  ...
                  <div class="flex-grow w-full flex flex-col gap-2">
                    ...
                    <div class="flex gap-4 items-center mb-4 mt-4">
                      ...
                      >
                        <img
                          id="avatar_1"
                          src="createProfile_files/member_avatar_453.png"
                          alt="Avatar"
                          class="object-cover"
                        />
                      </div>
                    ...
                    <div class="flex flex-col gap-2 w-full">
                      <div class="flex gap-2 items-center justify-between">
                        <div class="flex items-center gap-2">
                          <div class="h-full w-full animate-pulse">
                            <div
                              class="rounded-full w-7 h-7 bg-neutral-300"
                            ></div>
                          </div>
                          <div class="h-full w-full animate-pulse">
                            <div
                              class="rounded-xl w-36 h-5 bg-neutral-300"
                            ></div>
                          </div>
                        </div>
                        <div class="flex items-center gap-2">
...
<script>
  ...
  workButton.addEventListener("click", function () {
    window.location.href = "successCreateProfile";
  });
...
<script>
  $(document).ready(function () {
    $("#uploadFile").on("change", function () {
      ...
      $.ajax({
        url: "/api/upload.php", // URL вашего PHP файла
        type: "POST",
        data: formData,
        ...
        success: function (response) {
          try {
            ...
            localStorage.setItem("photo", jsonResponse.filePath);
            var avatar_1 = document.getElementById("avatar_1");
            var avatar_2 = document.getElementById("avatar_2");

            avatar_1.src = jsonResponse.filePath;
            avatar_2.src = jsonResponse.filePath;
          } catch (e) {
